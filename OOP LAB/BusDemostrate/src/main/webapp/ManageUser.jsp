...
<div class="container">
    <h2 class="heading">Manage User Details</h2>
</div>


<button class="open-button" onclick="openForm()">View User Details</button>
...
<button class="open-button-delete" onclick="openFormDelete()">Delete User</button>
