...
<body>
	...
	<main>
		<div class="container">
    		<h2 class="heading">Change Customer Details</h2>
		</div>
		
		<div class="table-data">
				<div class="order">
					<div class="head">
					<h3>Do You Want To view Customer Details </h3>
						
						<i class='bx bx-search' onclick="openForm()"></i>
							<div class="form-popup" id="myForm" >
  						<form action="userView" class="form-container" method="post">
  							<h2 style="color: #333; font-size: 24px;">View Customer Details</h2>
   							<label for="text"><b>CustomerID:</b></label>
    						<input type="text" placeholder="Enter customerid" name="cusid" required>
       ...
       <div class="update-enter">
				...
				<div class="head">
						<h3>Do You Want To Remove The Customer </h3>
		...
		<div class="form-popup-delete" id="myFormdelete">
  		  <form action="deleteCus" class="form-container-delete" method="post">
   			<h2 style="color: #333; font-size: 24px;">Delete Customer</h2>
