...
.update-enter form {
    width: 50%; /* Set the width of the form to 100% of the container */
}

.update-enter label,
.update-enter input,
.update-enter button {
    display: block; /* Display form elements as block-level to stack them vertically */
    width: 80%; /* Set the width of form elements to 100% */
    margin-bottom: -2px; /* Add some vertical spacing between elements */
}
.update-enter-delete {
    width: 80%; /* Set the width of the container */
    margin: 0 auto; /* Center the container horizontally */
    position: absolute; /* Position the division absolutely */
    bottom: 0; /* Align the division to the bottom of the page */
    left: 50%; /* Center the division horizontally */
    transform: translateX(-50%); /* Center the division horizontally */
    height: 400px; 
    overflow-y: auto; 
}
...
.form-popup {
  display: none;
  position: fixed;
  bottom: 50px; /* Adjusted from bottom: -20 */
  left: 350px; /* Changed from right: 15px */
...
<body>
	...
	<section id="content">
		...
		<main>
		<div class="container">
    <h2 class="heading">Change User Details</h2>
</div>
		
<div class="table-data">
				<div class="order">
					<div class="head">
						<h3>Do You want To View User Details</h3>
						<i class='bx bx-search' onclick="openForm()"></i>
						
					<div class="form-popup" id="myForm" >
  						<form action="userView" class="form-container" method="post">
  							<h2 style="color: #333; font-size: 24px;">View User</h2>
       ...
       <div class="update-enter">
				...
				<div class="head">
						<h3>Do You Want To Delete Any User </h3>
		...
		<div class="form-popup-delete" id="myFormdelete">
  		  <form action="/action_page.php" class="form-container-delete">
   			<h2 style="color: #333; font-size: 24px;">Delete User</h2>
