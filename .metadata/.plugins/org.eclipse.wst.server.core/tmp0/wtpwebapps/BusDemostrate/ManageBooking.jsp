...
<div class="container">
    <h2 class="heading">Manage Booking</h2>
</div>


<button class="open-button" onclick="openForm()">View Booking</button>

<div class="form-popup" id="myForm">
  <form action="/action_page.php" class="form-container" method="post">
  <h2 style="color: #333; font-size: 24px;">View Booking</h2>
    <label for="text"><b>Enter BookingId:</b></label>
...
<button class="open-button-delete" onclick="openFormDelete()">Delete Booking</button>
